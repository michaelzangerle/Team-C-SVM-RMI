...
public class PolicyFileLocator {
    public static final String POLICY_FILE_NAME = "/server.policy";     //Filename unsers Policy Files
    ...
    public static String getLocationOfPolicyFile() {
        try {
            File tempFile = File.createTempFile("rmi-server", ".policy");  //Erzeuge Tempfile
